package com.example.adpapaio.professorrating_cis436_papaioannou;
...
import com.example.adpapaio.professorrating_cis436_papaioannou.dummy.DummyContent;

import java.util.List;

/**
 * An activity representing a list of Professors. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link ProfessorDetailActivity} representing
...
public class ProfessorListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.professor_list);
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.professor_list_content, parent, false);
